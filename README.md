## Hi there, MySelf Harsh Dev Jha 👋, Founder and Chairperson of [eOzka](https://eozka.com)
...
[![Typing SVG_1](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=21&duration=3000&pause=1000&color=C7D6D9F3&background=FFE7C800&center=true&vCenter=true&random=true&width=435&lines=Why+must+I+fret+for+i+don't+exist%2C;+I+Just+Am+~)](https://git.io/typing-svg)
...
<hr width='40%'>
<sub><em style="color:#888888;">inkesk → origin&nbsp;&nbsp;|&nbsp;&nbsp;OSKA → trail&nbsp;&nbsp;|&nbsp;&nbsp;Vibhu → mind &nbsp;&nbsp;|&nbsp;&nbsp;ØSKA is its echo&nbsp;&nbsp;</em></sub>
<hr width='100%'>
</div>
...
<table border="0" width="100%">
  <tr>
    ...
    <td width="55%" valign="top">      
      ...
      <strong style="display: block; margin-top: 10px;">💻 Languages</strong>
      ...
      <strong style="display: block; margin-top: 10px;">🌐 Frontend & UI</strong>
      <div align="left" style="margin-top: 5px; margin-bottom: 10px;">
      ...
      <strong style="display: block; margin-top: 10px;">⚙️ Backend & Databases</strong>
      <div align="left" style="margin-top: 5px; margin-bottom: 10px;">
      ...
      <strong style="display: block; margin-top: 10px;">📊 Data Science & AI</strong>
      <div align="left" style="margin-top: 5px; margin-bottom: 10px;">
        <img src="https://img.shields.io/badge/numpy-013243?style=for-the-badge&logo=numpy&logoColor=white" />
        <img src="https://img.shields.io/badge/pandas-150458?style=for-the-badge&logo=pandas&logoColor=white" />
        <img src="https://img.shields.io/badge/Matplotlib-ffffff?style=for-the-badge&logo=Matplotlib&logoColor=black" />
      </div>
      <strong style="display: block; margin-top: 10px;">🚀 DevOps & Workflow</strong>
...
<table width="100%" cellpadding="10" cellspacing="10" border="0">
  <tr>
    <td width="50%" valign="top" bgcolor="#0d1117" style="border: 1px solid #30363d; border-radius: 8px; padding: 15px;">
      <h3>🧭 NAVRAAH</h3>
      <p style="color: #8b949e; margin-top: -10px;"><em>Navigation Assistant Via Real-Time Awareness & Audio Help</em></p>
      <div style="margin-bottom: 10px;">
        <img src="https://img.shields.io/badge/Python-3670A0?style=flat-square&logo=python&logoColor=ffdd54" />
        <img src="https://img.shields.io/badge/YOLOv8-ONNX-00FF00?style=flat-square" />
        <img src="https://img.shields.io/badge/OpenCV-Computer%20Vision-blue?style=flat-square&logo=opencv&logoColor=white" />
        <img src="https://img.shields.io/badge/Raspberry%20Pi-Hardware-C1F12E?style=flat-square&logo=raspberrypi&logoColor=red" />
      </div>
      <ul>
        <li>AI-powered navigation assistant designed for visually impaired users, achieving <b>73% object detection accuracy</b>.</li>
        <li>Real-time distance measurement using Ultrasonic Sensors with ultra-low <b>&lt;10ms sensor polling latency</b>.</li>
        <li>Speech-based directional object detection via background threads running processing pipelines at <b>30+ FPS</b>.</li>
    ...
    <td width="50%" valign="top" bgcolor="#0d1117" style="border: 1px solid #30363d; border-radius: 8px; padding: 15px;">
      <h3>🧠 MindSpace</h3>
      <p style="color: #8b949e; margin-top: -10px;"><em>Predictive Burnout & Emotional Intelligence Dashboard</em></p>
      <div style="margin-bottom: 10px;">
        <img src="https://img.shields.io/badge/Python-3670A0?style=flat-square&logo=python&logoColor=ffdd54" />
        <img src="https://img.shields.io/badge/Flask-Web-black?style=flat-square&logo=flask&logoColor=white" />
        <img src="https://img.shields.io/badge/NLTK-NLP-00A3E0?style=flat-square" />
      </div>
      <ul>
        <li>Multi-modal sentiment analysis on user interaction logs, yielding a ROC test result of <b>0.9030</b>.</li>
        <li>Temporal tracking of burnout and mental exhaustion states over a rolling <b>30-day sliding window</b>.</li>
        <li>High-fidelity visual dashboards displaying well-being aggregates across <b>5 key psychological markers</b>.</li>
        <li>Designed to predict student burnout and monitor mental wellness with <b>88% prediction confidence</b>.</li>
      </ul>
      <br/>
      <a href="https://github.com/eOzkull/MindSpace" target="_blank">
        <img src="https://img.shields.io/badge/REPOSITORY-GITHUB.COM%2FEOZKULL%2FMINDSPACE-441350?style=for-the-badge&logo=github" alt="Repository Link" />
      </a>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top" bgcolor="#0d1117" style="border: 1px solid #30363d; border-radius: 8px; padding: 15px;">
      <h3>🚀 entab-D</h3>
      <p style="color: #8b949e; margin-top: -10px;"><em>Intelligent Browser Tab Sorting & Organization Extension</em></p>
      <div style="margin-bottom: 10px;">
        <img src="https://img.shields.io/badge/JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black" />
        <img src="https://img.shields.io/badge/Chrome%20Extension-API-green?style=flat-square&logo=googlechrome&logoColor=white" />
        <img src="https://img.shields.io/badge/HTML5/CSS3-Web-orange?style=flat-square" />
      </div>
      <ul>
        <li>One-click sorting of cluttered active browser tabs, capable of handling <b>100+ open tabs</b> dynamically.</li>
        <li>Rule-based tab grouping using the Chrome Extensions API with execution speed <b>&lt;50ms</b>.</li>
        <li>Domain extraction logic to consolidate groups by website, lowering browser memory footprint by <b>up to 40%</b>.</li>
        <li>Unpacked developer-mode deployment for Chrome, supporting <b>100% offline rule configuration</b>.</li>
      </ul>
      <br/>
      <a href="https://github.com/eOzkull/entab-D" target="_blank">
        <img src="https://img.shields.io/badge/REPOSITORY-GITHUB.COM%2FEOZKULL%2FENTAB--D-8A2BE2?style=for-the-badge&logo=github" alt="Repository Link" />
      </a>
    </td>
    <td width="50%" valign="top" bgcolor="#0d1117" style="border: 1px solid #30363d; border-radius: 8px; padding: 15px;">
      <h3>📊 Stress Calculator</h3>
      <p style="color: #8b949e; margin-top: -10px;"><em>Cardiovascular Stress Evaluation & Recovery App</em></p>
      <div style="margin-bottom: 10px;">
        <img src="https://img.shields.io/badge/Flutter-Framework-02569B?style=flat-square&logo=flutter&logoColor=white" />
        <img src="https://img.shields.io/badge/Dart-Language-0175C2?style=flat-square&logo=dart&logoColor=white" />
        <img src="https://img.shields.io/badge/Android/Web-Deployment-blueviolet?style=flat-square" />
      </div>
      <ul>
        <li>Estimates stress levels using pulse rate & blood pressure rules with <b>96% clinical formula alignment</b>.</li>
        <li>Delivers personalized breathing, meditation, and physical recommendations under <b>3 actionable recovery tiers</b>.</li>
        <li>Local SQLite history log and trend charts showing up to <b>12 months of historical data</b>.</li>
        <li>Cross-platform web app and downloadable Android APK optimized for <b>60 FPS</b> animations.</li>
      </ul>
      <br/>
      <a href="https://github.com/eOzkull/stress-calculator" target="_blank">
        <img src="https://img.shields.io/badge/REPOSITORY-GITHUB.COM%2FEOZKULL%2FSTRESS--CALCULATOR-00A3E0?style=for-the-badge&logo=github" alt="Repository Link" />
      </a>
    </td>
  </tr>
</table>
...
[![spotify-github-profile](https://spotify-github-profile.kittinanx.com/api/view?uid=y15tkxab4npvopej6nw75rujd&cover_image=true&theme=spotify-embed&show_offline=true&background_color=b13535&interchange=true&profanity=true&hide_remaster=true&bar_color=53b14f&bar_color_cover=true&mode=dark)](https://spotify-github-profile.kittinanx.com/api/view?uid=y15tkxab4npvopej6nw75rujd&redirect=true)
